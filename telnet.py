...
def main():
    ...
    parser.add_argument('--host', type=str, default='0.0.0.0', help='Host to bind the Telnet server to.')
    parser.add_argument('--port', type=int, default=2323, help='Port to bind the Telnet server to.')
